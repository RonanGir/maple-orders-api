...
VALUES
    ('2023-01-15 10:45:23+00', 1, '2023-02-10 15:32:11+00', 'John Doe'),
...
(
    ...
    customer_id bigint                      not null constraint fk_cart_customer_id references public.customer
);

INSERT INTO public.cart (quantity, total_price, created_at, id, updated_at, customer_id, status)
VALUES
    (3, 59.99, '2023-09-01 11:25:33+00', 1, '2023-09-02 13:45:15+00', 1, 'OPENED'),
...
VALUES
    (100, 13.5, 50, '2023-01-15 10:00:00+00', 1, '2023-01-16 09:30:00+00', 'Sirop d''érable pur du Vermont.', 'maple_syrup_amber.jpg', 'Sirop d''érable ambré du Vermont', 'AMBER'),
    (200, 15, 75, '2023-02-10 11:30:00+00', 2, '2023-02-11 10:45:00+00', 'Sirop d''érable noir riche, idéal pour la pâtisserie', 'maple_syrup_dark.jpg', 'Sirop d''érable noir canadien', 'DARK'),
    (150, 10.25, 30, '2023-03-05 14:20:00+00', 3, '2023-03-06 13:50:00+00', 'Sirop d''érable clair et léger, parfait pour les crêpes.', 'maple_syrup_clear.jpg', 'Sirop d''érable clair du New Hampshire', 'CLEAR');
...
(
    ...
    status      varchar(255)                not null
        constraint cart_item_status_check
            check ((status)::text = ANY
                   ((ARRAY ['OPENED'::character varying, 'PENDING'::character varying, 'CLOSED'::character varying])::text[])),
    cart_id     bigint                      not null constraint fk_cart_item_cart_id references public.cart,
    product_id  bigint                      not null constraint fk_cart_item_product_id references public.product,
    customer_id bigint                      not null constraint fk_cart_item_customer_id references public.customer
);

INSERT INTO public.cart_item (quantity, total_price, cart_id, created_at, id, product_id, updated_at, customer_id, status)
VALUES
    (2, 27, 1, '2023-09-01 12:30:45+00', 1, 1, '2023-09-02 09:20:33+00', 1, 'OPENED'),
...
(
    ...
    status      varchar(255)                not null
        constraint purchase_order_status_check
            check ((status)::text = ANY
                   ((ARRAY ['OPENED'::character varying, 'PENDING'::character varying, 'CLOSED'::character varying])::text[])),
    customer_id bigint                      not null constraint fk_purchase_order_customer_id references public.customer
);

INSERT INTO public.purchase_order (quantity, total_price, created_at, id, updated_at, customer_id, status)
VALUES
    (2, 27, '2023-09-12 10:20:30+00', 1, '2023-09-13 14:30:25+00', 1, 'PENDING'),
...
(
    ...
    status      varchar(255)                not null
        constraint purchase_order_item_status_check
            check ((status)::text = ANY
                   ((ARRAY ['OPENED'::character varying, 'PENDING'::character varying, 'CLOSED'::character varying])::text[])),
    order_id    bigint                      not null constraint fk_purchase_order_item_order_id references public.purchase_order,
    product_id  bigint                      not null constraint fk_purchase_order_item_product_id references public.product,
    customer_id bigint                      not null constraint fk_purchase_order_item_customer_id references public.customer
);

INSERT INTO public.purchase_order_item (quantity, total_price, created_at, id, order_id, product_id, updated_at, customer_id, status)
VALUES
    (2, 27, '2023-09-12 11:45:22+00', 1, 1, 1, '2023-09-13 12:00:10+00', 1, 'PENDING'),
